...
styled_caption <- "<span style='font-family: Arial; font-size: 18px; font-weight: bold; color: black;'>Summary of Primary Composite in EMERGE</span>"
knitr::kable(EMERGE_background_stats, caption = styled_caption, align = 'c', format = "html") %>%
...
```{r morefigs2, out.width='95%', echo=FALSE, fig.cap='Power of Permutation Test', fig.height=4}
