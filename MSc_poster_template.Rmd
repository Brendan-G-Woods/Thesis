...
# Early Results 
```{r morefigs, out.width='90%', echo=FALSE, fig.cap='Permuted Null Distribution of Composite. Test statistic 28.89, P-value of P<0.001', fig.height=6}
...
ggplot(squared_composite.df, aes(x= squared_composite))+
  ...
  annotate("text", x = percentile_95, y = 250, label = "95th Percentile", color = "maroon", angle = 90, vjust = -0.5, size = 7)+
  theme_minimal()+
...
```{r morefigs2, out.width='95%', echo=FALSE, fig.cap='Power of Permutation Test', fig.height=5}
