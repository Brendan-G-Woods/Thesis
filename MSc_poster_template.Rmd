...
You can even use the bibliography the same way: Our data were taken from a cluster-randomised trial, available from the [Irish Social Science Data Archive](https://www.ucd.ie/issda/data/).
